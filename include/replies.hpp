...
inline std::string errUnknownCommand(const std::string& serverName,
									 const std::string& nick,
									 const std::string& command)
{
	return ":" + serverName + " 421 " + nick + " " + command +
		   " :Unknown command\r\n";
}
...
inline std::string rplCreated(const std::string& serverName,
							  const std::string& nick, const std::string& date)
{
	return ":" + serverName + " 003 " + nick + " :This server was created " +
		   date + "\r\n";
}
							 ...
							 const std::string& channelModes)
{
	...
	return ":" + serverName + " 004 " + nick + " :" + serverName + " " +
...
inline std::string errNicknameInUse(const std::string& serverName,
									const std::string& nick)
{
	return ":" + serverName + " 433 " + nick + " " + nick +
...
inline std::string errInviteOnlyChan(const std::string& serverName,
									 ...
									 const std::string& channel)
{
	return ":" + serverName + " 473 " + nick + " " + channel +
		   " :Cannot join channel (+i)\r\n";
}
...
inline std::string errBadChannelKey(const std::string& serverName,
									...
									const std::string& channel)
{
	return ":" + serverName + " 475 " + nick + " " + channel +
		   " :Cannot join channel (+k)\r\n";
}
...
inline std::string errChannelIsFull(const std::string& serverName,
									...
									const std::string& channel)
{
	return ":" + serverName + " 471 " + nick + " " + channel +
		   " :Cannot join channel (+l)\r\n";
}
...
inline std::string errNoSuchChannel(const std::string& serverName,
									...
									const std::string& channel)
{
	return ":" + serverName + " 403 " + nick + " " + channel +
		   " :No such channel\r\n";
}
...
inline std::string rplPart(const std::string& nick, const std::string& username,
						   const std::string& hostname,
						   const std::string& channelName,
						   const std::string& partMessage)
{
	return ":" + nick + "!~" + username + "@" + hostname + " PART " +
...
inline std::string errKeySet(const std::string& serverName,
							 ...
							 const std::string& channel)
{
	return ":" + serverName + " 467 " + nick + " " + channel +
		   " :Channel key already set\r\n";
}

// ERR_NOCHANMODES (477) - custom or non-standard; indicates no channel modes
// are supported
...
inline std::string errChanPrivsNeeded(const std::string& serverName,
									  ...
									  const std::string& channel)
{
	return ":" + serverName + " 482 " + nick + " " + channel +
		   " :You're not channel operator\r\n";
}
...
inline std::string errUserNotInChannel(const std::string& serverName,
									   ...
									   const std::string& channel)
{
	return ":" + serverName + " 441 " + nick + " " + channel +
		   " :They aren't on that channel\r\n";
}
...
{
	return ":" + servername + " 472 " + nick + " " + channel +
		   " :unknown mode " + mode + "\r\n";
}
...
inline std::string rplNoTopic(const std::string& serverName,
							  ...
							  const std::string& channel)
{
	return ":" + serverName + " 331 " + nick + " " + channel +
		   " :No topic is set\r\n";
}
...
inline std::string errNotOnChannel(const std::string& serverName,
								   ...
								   const std::string& channel)
{
	return ":" + serverName + " 442 " + nick + " " + channel +
...
inline std::string errCannotSendToChan(const std::string& serverName,
									   ...
									   const std::string& channel)
{
	return ":" + serverName + " 404 " + nick + " " + channel +
		   " :Cannot send to channel\r\n";
}
...
inline std::string errNoSuchNick(const std::string& serverName,
								 ...
								 const std::string& target)
{
	return ":" + serverName + " 401 " + nick + " " + target +
